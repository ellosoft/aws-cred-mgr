...
///     and use the variable placeholder (variable name) in the output file
/// </summary>
public class ResourceConfigurationInspector(ITypeInspector innerTypeDescriptor) : TypeInspectorSkeleton
{
    /// <summary>
